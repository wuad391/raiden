        ...
        if subcommand == "teleop":
            ...
            tyro.cli(
                ...
                description=(
                    ...
                    "Workflow:\n"
                    "  Demonstrations are marked Success or Failure at the keyboard\n"
                    "  verdict prompt right after each episode stops. Open the console\n"
                    "  only to correct mistakes. Only successful demonstrations are\n"
                    "  converted when you run  rd convert.\n\n"
                    "Marking during recording (without opening the console):\n"
                    "  Enter / leader button   Start or stop recording\n"
                    "  Foot pedal              Mark a subtask boundary (while recording)\n"
                    "  Verdict prompt          Enter = Success   f = Failure   other = skip\n\n"
